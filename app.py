...
# Add script directory to Python path to ensure module imports succeed in all cloud environments
...
(tab_dashboard, tab_mapping, tab_historical, tab_siting, tab_logistics, tab_mas, 
 tab_sbce, tab_advantages, tab_financing, tab_consortium, tab_pyrolysis, tab_calculator, tab_articles) = st.tabs([
    _("tab_dashboard"), 
    _("tab_mapping"), 
    _("tab_historical"),
    _("tab_siting"),
