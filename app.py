...
# Adiciona o diretório do app ao sys.path para garantir execução no Streamlit Cloud
...
# Importação com Fallback Defensivo Inline (100% Imune a ImportError no Streamlit Cloud)
try:
    from data_sc import CROP_PARAMS, get_sc_dataframe, calculate_potentials
except Exception as _e_datasc:
    MJ_TO_MWH = 1.0 / 3600.0
    CROP_PARAMS = {
        "Arroz": {"lhv": 13.75, "residue_factor": 1.0, "eta": 0.25, "biochar_yield": 0.10, "carbon_content": 0.5892},
        "Soja": {"lhv": 16.00, "residue_factor": 0.73, "eta": 0.25, "biochar_yield": 0.10, "carbon_content": 0.5892},
        "Milho": {"lhv": 17.50, "residue_factor": 0.58, "eta": 0.25, "biochar_yield": 0.10, "carbon_content": 0.5892},
        "Trigo": {"lhv": 16.50, "residue_factor": 1.00, "eta": 0.25, "biochar_yield": 0.10, "carbon_content": 0.5892},
        "Feijão": {"lhv": 15.50, "residue_factor": 1.00, "eta": 0.25, "biochar_yield": 0.10, "carbon_content": 0.5892}
    }
    MUNICIPALITIES_DATA = [
        ...
        {"municipio": "Joinville", "regiao": "Norte", "lat": -26.30, "lon": -48.84, "Arroz": 25000, "Soja": 5000, "Milho": 15000, "Trigo": 2000, "Feijão": 1000},
        ...
        {"municipio": "Campos Novos", "regiao": "Meio-Oeste", "lat": -27.40, "lon": -51.22, "Arroz": 8000, "Soja": 380000, "Milho": 195000, "Trigo": 90000, "Feijão": 10000},
        {"municipio": "Lages", "regiao": "Planalto Serrano", "lat": -27.81, "lon": -50.32, "Arroz": 10000, "Soja": 90000, "Milho": 80000, "Trigo": 25000, "Feijão": 15000},
        {"municipio": "Florianópolis", "regiao": "Grande Florianópolis", "lat": -27.59, "lon": -48.54, "Arroz": 1000, "Soja": 500, "Milho": 2000, "Trigo": 0, "Feijão": 500}
    ]
    ...
    def calculate_potentials(df, collect_rate=0.20):
        ...
        for crop, params in CROP_PARAMS.items():
            ...
            multiplier_eletrico = 1000.0 * params["lhv"] * (1.0 / 3600.0) * params["eta"]
...
except Exception as _e_mas:
    # -*- coding: utf-8 -*-
    import pandas as pd
    # CROP_PARAMS already in scope
